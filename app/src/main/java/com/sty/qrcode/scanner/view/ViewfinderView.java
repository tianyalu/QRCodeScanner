package com.sty.qrcode.scanner.view;
...
import com.sty.qrcode.scanner.R;
...
public final class ViewfinderView extends View {
    ...
    /**
     * 在camera聚焦获取图片后，再使用core中的库进行解析，会得出特征点的坐标，
     * 最后通过ViewfinderResultPointCallback类回调，将特征点添加到ViewfinderView中的容器中。
     * @param point
     */
